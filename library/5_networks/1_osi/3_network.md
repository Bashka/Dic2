...
1. При запуске маршрутизатор сообщает о себе информацию с помощью специальных пакетов, которыми обмениваются все маршрутизаторы. Этот процесс называется 'настройкой' и служит для построения таблицы маршрутов;
