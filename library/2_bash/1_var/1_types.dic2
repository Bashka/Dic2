...
2. Целые числа (1 0 -5) - данные, содержащие только числа и, возможно, знак минус для обозначения отрицательных чисел;
...
4. Логический тип (0 1) - число ноль соответствует истине, а любое отличное от него - лжи.
