...
2. <имяПакета>-><имяФункции>() - вызов функции как статического метода класса;
3. <имяФункции> <имяПакета>() - вызов функции как статического метода класса.
...
2. Как оператор - new MyClass();
3. Как метод объекта того же класса - $obj->new().
